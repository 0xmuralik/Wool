...
use crate::msg::{ExecuteMsg, FundsResponse, InstantiateMsg, PriceResponse, QueryMsg};
...
pub fn try_swap_tokens(
    ...
    pool.coins[give_coin_index].amount = pool.coins[give_coin_index]
        .amount
...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> StdResult<Binary> {
    match msg {
        ...
        QueryMsg::GetPrice {
            ...
            denom1,
            denom2,
        } => to_binary(&query_price(deps, pool_id, denom1, denom2)?),
    }
}
...
mod tests {
    ...
    fn swap() {
        ...
        let res = query(
            ...
            QueryMsg::GetPrice {
                pool_id: "POOL1".to_string(),
                denom1: "mars".to_string(),
                denom2: "earth".to_string(),
            },
        )
        .unwrap();
        let value: PriceResponse = from_binary(&res).unwrap();
